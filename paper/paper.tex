...
\usepackage{caption}
\usepackage[numbers]{natbib}  % Add citation management
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figures/SSM_example_fig1.png}
...
% figure %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!htp]
\includegraphics[height=200px,width=200px]{figures/rdm_choice_rt_dists.png}
...
% figure %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!htp]
\includegraphics[height=200px,width=200px]{figures/rdm_trace_plot.png}
...
% figure %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!htp]
\includegraphics[height=300px,width=220px]{figures/posterior_distributions.png}
